...
const createTODO = (name, projectIndex, priority, description, dueDate) => {
    const todo = _model_todo__WEBPACK_IMPORTED_MODULE_1__.getNewTODO(name, priority, description, (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(dueDate, 'dd.L.yy'));
